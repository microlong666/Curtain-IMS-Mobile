...
<script>
import { getMainFabricList } from '@/api/items'
...
export default {
  ...
  methods: {
    ...
    async onLoad() {
      ...
      const res = await getMainFabricList(this.params)
      if (res.data.code === 0) {
